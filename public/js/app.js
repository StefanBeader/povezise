...
/* harmony import */ var _components_contact_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/contact_form */ "./resources/js/components/contact_form.js");
/* harmony import */ var _components_order__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/order */ "./resources/js/components/order.js");
/* harmony import */ var _components_mobileMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/mobileMenu */ "./resources/js/components/mobileMenu.js");
/* harmony import */ var _components_mobileMenu__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_mobileMenu__WEBPACK_IMPORTED_MODULE_4__);
...
/***/ "./resources/js/components/contact_form.js":
/*!*************************************************!*\
  !*** ./resources/js/components/contact_form.js ***!
  \*************************************************/
/*! no exports provided */
...
/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./request */ "./resources/js/components/request.js");
/* harmony import */ var _getFormData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getFormData */ "./resources/js/components/getFormData.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            clearErrors();
            formData = Object(_getFormData__WEBPACK_IMPORTED_MODULE_2__["default"])(form);
            _context.next = 7;
            return Object(_request__WEBPACK_IMPORTED_MODULE_1__["default"])('/contactMessage', formData);
...
function showResponse(response) {
  ...
  if (validationErrors) {
    Object.keys(validationErrors).map(function (key) {
      var messageHolder = document.querySelector('#' + form.id + ' .' + key);
      var inputField = document.querySelector('#' + form.id + ' [name=' + key + ']');
    ...
    var el = document.getElementById('ContactMessageResponse');
...
function clearErrors() {
  var inputsWithErrors = _toConsumableArray(document.getElementsByClassName('error'));

  inputsWithErrors.forEach(function (input) {
    input.classList.remove('error');
  });

  var errorMessages = _toConsumableArray(form.getElementsByClassName('error-message'));
...
/***/ "./resources/js/components/getFormData.js":
/*!************************************************!*\
  !*** ./resources/js/components/getFormData.js ***!
  \************************************************/
...
function getFormData(form) {
  ...
  var object = {};
  Object.keys(serialized).map(function (key) {
    object[serialized[key].name] = serialized[key].value;
  });
  return object;
}
...
/***/ "./resources/js/components/mobileMenu.js":
/*!***********************************************!*\
  !*** ./resources/js/components/mobileMenu.js ***!
  \***********************************************/
/*! no static exports found */
...
var linksMobile = _toConsumableArray(document.getElementsByClassName('link-tag-mobile'));
...
function scrollToSectionMobile(e) {
  e.preventDefault();
  closeMenu();
  sections[e.target.dataset.id].scrollIntoView({
    block: "start",
    behavior: "smooth"
  });
}
...
var orderButtons = _toConsumableArray(document.getElementsByClassName('order-btn'));

var modal = document.getElementById('tryFreeModal');
var packageId;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            clearErrors();
            requestInProgress = true;
            data = Object(_getFormData__WEBPACK_IMPORTED_MODULE_2__["default"])(form);
            data['package_id'] = packageId;
            _context.next = 8;
            return Object(_request__WEBPACK_IMPORTED_MODULE_1__["default"])('/sendOrder', data);
...
function showResponse(response) {
  ...
  if (validationErrors) {
    ...
    var el = document.getElementById('OrderResponseMessage');
    el.classList.add(response.error ? 'error' : 'success');
    el.innerText = response.message;
  }
}
...
function howToContact(e) {
  ...
  var input = getInputByOption(option);
...
function displayInput(input) {
  var wrapper = document.getElementById('howToContactInput');
  wrapper.innerHTML = "";
  wrapper.innerHTML = '<label>' + input.label + '</label>' + input.html + '<span class="error-message contact_value"></span>';
}
...
/***/ "./resources/js/components/request.js":
/*!********************************************!*\
  !*** ./resources/js/components/request.js ***!
  \********************************************/
/*! exports provided: default */
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return fetch(url, requestBody).then(
            /*#__PURE__*/
            function () {
                    ...
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        return _context.abrupt("return", {
                          message: 'Greška u sistemu, molimo Vas probajte kasnije.',
                          error: true
                        });
                      ...
                      case 8:
                        return _context.abrupt("return", {
                          message: 'Akcija uspešno izvršena. Kontaktiraćemo Vas u najkraćem roku.',
                          error: false
                        });
              ...
              return {
                message: 'Greška, molimo Vas proverite Vašu internet konekciju.',
                error: true
              };
            });
...
var links = _toConsumableArray(document.getElementsByClassName('link-tag'));

links.forEach(function (link) {
  link.addEventListener('click', scrollToSection, false);
});
document.addEventListener('wheel', handleScroll, false);
var tabletAndLess = window.matchMedia("(max-width: 1050px)");
var isMobile = tabletAndLess.matches;
